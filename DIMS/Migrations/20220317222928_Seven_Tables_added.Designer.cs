...
namespace DIMS.Migrations
{
    ...
    [Migration("20220317222928_Seven_Tables_added")]
    partial class Seven_Tables_added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DIMS.Entities.BranchItem", b =>
                {
                    b.HasOne("DIMS.Entities.Branch", null)
            ...
            modelBuilder.Entity("DIMS.Entities.Enterprise", b =>
                {
                    b.HasOne("DIMS.Entities.BranchItem", null)
                        .WithMany("Enterprises")
                        .HasForeignKey("BranchItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DIMS.Entities.CapitalSource", null)
                        .WithMany("Enterprises")
                        .HasForeignKey("CapitalSourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DIMS.Entities.EnterpriseLevel", null)
                        .WithMany("Enterprises")
                        .HasForeignKey("EnterpriseLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DIMS.Entities.EnterpriseStatus", null)
                        .WithMany("Enterprises")
                        .HasForeignKey("EnterpriseStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DIMS.Entities.GroupType", null)
                        .WithMany("Enterprises")
                        .HasForeignKey("GroupTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DIMS.Entities.PromotionLevel", null)
                        .WithMany("Enterprises")
            ...
            modelBuilder.Entity("DIMS.Entities.EnterpriseAddressInfo", b =>
                {
                    b.HasOne("DIMS.Entities.City", null)
                        .WithMany("EnterpriseAddressInfos")
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DIMS.Entities.Enterprise", null)
                        .WithMany("EnterpriseAddressInfos")
            ...
            modelBuilder.Entity("DIMS.Entities.Member", b =>
                {
                    b.HasOne("DIMS.Entities.Gender", null)
                        .WithMany("Members")
                        .HasForeignKey("GenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DIMS.Entities.MemberType", null)
                        .WithMany("Members")
                        .HasForeignKey("MemberTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DIMS.Entities.Title", null)
                        .WithMany("Members")
